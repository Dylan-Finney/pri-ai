import { agentDemoPrompts } from "../agents";
import { OpenAIStreamChat } from "../OpenAIStream";
import { getCurrentUser } from "aws-amplify/auth";

export const runtime = "edge";

export async function chatDemo({ persona, prompt, chatlog, agent }) {
  if (persona && prompt) {
...
export async function chatFull({ persona, prompt, chatlog, agent }) {
  try {
